#!/usr/bin/env python3
"""A tiny, real generator to demonstrate generated-sink-commit-gate.
...
def render(source_text: str) -> str:
    # A deliberately trivial, deterministic transform. Real generators do more,
    # but the property that matters is the same: source fully determines sink.
